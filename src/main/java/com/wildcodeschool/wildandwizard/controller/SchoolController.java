...
public class SchoolController {
    ...
    @Autowired
    private SchoolRepository srepository;

    @GetMapping("/schools")
    public String getAll(Model model) {

        model.addAttribute("schools", srepository.findAll());
    ...
    public String getSchool(Model model,
        ...
        if (id != null) {
            Optional<School> optionalSchool = srepository.findById(id);
